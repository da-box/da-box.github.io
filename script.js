...
function initTHREE() {
	...
	light = new THREE.DirectionalLight(0x00500, 1);
...
function initParticleSystem() {
	...
	var material = new THREE.BAS.PhongAnimationMaterial(
		// custom parameters & THREE.MeshPhongMaterial parameters
		{
			...
			shaderFunctions: [THREE.BAS.ShaderChunk["quaternion_rotation"]],
...
THREE.BAS.ShaderChunk["ease_functions"] =
